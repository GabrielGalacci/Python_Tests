"""
TDD - Test Driven Development (Desenvolvimento Dirigido à Testes)

Red
Parte 1 -> Criar o teste e ver falhar

Green
Parte 2 -> Criar o código e ver o código passar
...
class TestBaconComOvos(TestCase):
    ...
    def test_bacon_com_ovos_deve_retornar_bacom_com_ovos_se_entrada_for_multiplo_de_3_e_5(self):
